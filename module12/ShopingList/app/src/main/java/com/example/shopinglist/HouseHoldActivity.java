...
public class HouseHoldActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.list_view_house_hold);
    ...
    public void onClickButtonAddHouseHold(View view) {
        EditText editText = findViewById(R.id.edit_text_house_hold);
    ...
    public void onClickButtonRemoveHouseHold(View view) {
